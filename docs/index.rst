...
It was first developed to predict the rotation period of stars from various stellar properties, and is intended to predict long rotation periods (e.g. those of M-dwarfs) from short TESS  lightcurves (27-day lightcurves). 

We provide access to models, trained on stars from the catalog by `McQuillan et al. (2014) <https://arxiv.org/abs/1402.5694>`_. Users can predict whether the rotation period can be recovered and then predict recoverable rotation periods for the stars in the Kepler field using their temperatures, colors, kinematics, and other stellar properties. 
